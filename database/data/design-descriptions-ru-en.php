...
/*
 * The same lines about each design, in Russian and English. Written from the
 * Azerbaijani ones, not word for word: what the design looks like, who it
 * suits and which photo works on it. The owner's own wording always wins —
 * these only fill what he has left empty.
 *
 * Shape: slug => ['ru' => [name?, description], 'en' => [name?, description]].
 * A name is given only where the Azerbaijani one is a phrase rather than a
 * brand; "Milka" or "Love Story" read the same in every language.
 */
return [
    'alpen-gold' => [
    ...
    'dark-spotify' => [
        'ru' => ['description' => 'Тёмный плеер Spotify: ваше фото, название песни и исполнитель. Для пар, у которых есть «наша песня», и для тех, кто живёт музыкой.'],
        'en' => ['description' => 'A dark Spotify player: your photo, the track name and the artist. For couples with “our song” and for anyone who lives by music.'],
    ],
    'family-frame' => [
        'ru' => ['description' => 'Семейное фото в рамке с национальным орнаментом и надписью «Портрет счастливой семьи». Родителям, бабушке с дедушкой и к семейным праздникам.'],
        'en' => ['description' => 'A family photo in a frame of national ornament, under the words “a happy family portrait”. For parents, grandparents and family celebrations.'],
    ],
    'frame-player' => [
        'ru' => ['description' => 'Две любимые вещи вместе: ваше фото как пост в Instagram, а под ним музыкальный плеер. Подойдёт семье, любимому человеку и другу.'],
    ...
    'i-love' => [
        'ru' => ['description' => 'Фото под наклоном на фоне повторяющегося «I love you» и много места для признания. К 14 февраля и годовщине.'],
    ...
    'kinder-vol-2' => [
        ...
        'en' => ['description' => 'Kinder Chocolate styling: your photo on top, and lines below for the warmest words you have. For a child or for someone you love.'],
    ],
    'love-story-vol-1' => [
        'ru' => ['description' => 'Розовый дизайн «Special edition»: имя в заголовке, фото пары по центру и длинный текст о любви внизу. Один из самых любимых романтических дизайнов.'],
    ...
    'love-story-vol-3' => [
        ...
        'en' => ['description' => 'Two photos set like postage stamps on red, with a “Happy Valentine’s Day” line. A design made for 14 February.'],
    ],
    'milka' => [
        'ru' => ['description' => 'Сиреневый дизайн в стиле Milka, ваше общее фото на фоне Альп. Любимому человеку, подруге и всем, кто любит Milka.'],
        'en' => ['description' => 'A lilac design in Milka’s style, with your photo against the Alps. For a partner, a friend, and every Milka lover.'],
    ],
    'netflix' => [
        'ru' => ['description' => 'Как афиша Netflix: «в главных ролях» ваши имена, ниже короткое описание и фото. Парам и друзьям, которые понимают шутку.'],
    ...
    'love-is-red' => [
        ...
        'en' => ['description' => 'A red “Love is…”: your confession among the hearts. The one to pick for 14 February, or for finally saying it.'],
    ],
];
